...
from automated_run_result import AutomatedRunResult, AirResult, UnknownResult, BlankResult

from identifier import get_analysis_type, make_rid, make_runid, is_special, \
    convert_extract_device

from position_regex import XY_REGEX
from pychron_constants import SCRIPT_KEYS, SCRIPT_NAMES, ALPHAS, DETECTOR_IC

# logger = new_logger('AutomatedRunSpec')
logger = logging.getLogger('AutomatedRunSpec')
